...
export default class Learning extends Component {
   ...
   requestAPI = () => {
    fetch(`https://api.breezometer.com/pollen/v2/forecast/daily?lat=${this.state.location.coords.latitude}&lon=${this.state.location.coords.longitude}&key=8d69f59b396740af97c6ace202996808&features=breezometer_aqi,local_aqi,health_recommendations,sources_and_effects,pollutants_concentrations,pollutants_aqi_information`).then((response) => response.json())
    .then((res) => {
